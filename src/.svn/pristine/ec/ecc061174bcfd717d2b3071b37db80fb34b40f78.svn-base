...
//    public ImageFeature imageFeatureScale(ImageFeature imageFeatures) {
////        final svm_node[] feature = imageFeatures.getFeature();
////        final int annotation = imageFeatures.getAnnotation();
////
////        for (int i = 0; i < feature.length; i++) {
////            feature[i] = (float) output(i, feature[i]);
////        }
//        
//        return new ImageFeature(feature, annotation);
//
//    }

    public ArrayList<ImageFeature> scaleImageFeatures(ArrayList<ImageFeature> allImageFeatures) {
        ArrayList<ImageFeature> result = new ArrayList<ImageFeature>();
//        lower = -1;
//        upper = 1;
//        svm_node[] firstFeatures = allImageFeatures.get(0).getFeature();
...
//            feature_max[i] = feature_min[i] = firstFeatures[i];
//        }
//
//        for (ImageFeature imageFeatures : allImageFeatures) {
//            float[] features = imageFeatures.getFeature();
//            for (int i = 0; i < features.length; i++) {
//                feature_max[i] = (getFeature_max()[i] > features[i]) ? getFeature_max()[i] : features[i];
//                feature_min[i] = (getFeature_min()[i] < features[i]) ? getFeature_min()[i] : features[i];
//            }
//        }
//
//        for (ImageFeature imageFeatures : allImageFeatures) {
//            
//            final float[] features = imageFeatures.getFeature();
//            final int annotation = imageFeatures.getAnnotation();
//
//            for (int i = 0; i < features.length; i++) {
//                features[i] = (float) output(i, features[i]);
//            }
//
//            result.add(new ImageFeature(features, annotation));
//            
//        }
//
        return result;
